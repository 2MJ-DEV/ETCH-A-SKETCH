...
function confirmClear(){
    if (confirm("Vous aller vider votre croquis !")) clearSketch();
}
...
slider.oninput = function() {
    ...
    sliderValue.textContent = `${this.value} x ${this.value} Taille Quadrillage`;
    removeGridSquares();
    createGridSquares();
}
sliderValue.textContent = `${slider.value} x ${slider.value} Taille Quadrillage`;
